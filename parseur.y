...
%%
prog: PROGRAM IDENT ';' RL dec_var RL DEBUT RL corps_prog RL FINPROG { programmePrincipal(yyout, $5, $9);};
...
dec_const: CONST liste_const {};
liste_const: IDENT ':' TYPE '=' val_const {}
val_const: NOMBRE { $$ = $1;}
         | CHAR { $$ = $1;}
         | CHAINE { $$ = $1;}
